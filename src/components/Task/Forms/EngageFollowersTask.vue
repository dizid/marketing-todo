<template>
  <div class="space-y-4">
    <div>
      <label class="block text-sm font-medium text-gray-700 mb-2">Reply Templates</label>
      <textarea v-model="formData.replyTemplates" placeholder="Common reply templates for followers..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none resize-vertical min-h-[100px]"></textarea>
    </div>
    <div>
...
const formData = ref({ replyTemplates: '', notes: '' })
