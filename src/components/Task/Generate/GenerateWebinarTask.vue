<template>
  <div class="space-y-4">
    <p class="text-sm text-gray-600">Click "Save" to use AI generation for this task.</p>
    <div>
      <label class="block text-sm font-medium text-gray-700 mb-2">Generated Content</label>
      <textarea v-model="formData.content" placeholder="AI-generated content will appear here. Edit as needed..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none resize-vertical min-h-[150px]"></textarea>
    </div>
    <div>
...
const formData = ref({ content: '', notes: '' })
